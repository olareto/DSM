...
namespace DSM5.Controllers
{
    public class EventoController : BasicController
    {
        ...
        public ActionResult Filtroprecio(int min,int max,int limit)
        {
            ...
            EventoCEN cen = new EventoCEN();
            IList<EventoEN> enlinst = cen.Filtroprecio(min,max);
        ...
        public ActionResult Filtronombre(String name)
        {
            ...
            EventoCEN cen = new EventoCEN();
            IList<EventoEN> enlinst = cen.Filtronombre(name);
        ...
        // GET: Articulo/Filtrotipo/5
        ////////////////

        public ActionResult Filtrotipo(String tipo)
        {

            EventoCEN cen = new EventoCEN();
            IList<EventoEN> enlinst = cen.Filtrotipo(tipo);
        ...
        // POST: Articulo/Filtrotipo/5
        [HttpPost]
        public ActionResult Filtrotipo(int id, FormCollection collection)
        {
            try
            {
                // TODO: Add delete logic here
        ...
        public ActionResult Filtrovalor(int valor)
        {
            ...
            EventoCEN cen = new EventoCEN();
            IList<EventoEN> enlinst = cen.Filtrovalor((SMPGenNHibernate.Enumerated.SMP.ValoracionEnum)valor);
