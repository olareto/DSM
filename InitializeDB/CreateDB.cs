...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                int idproducto4 = productoCEN.New_ ("FunkoPop Frodo", 29, "FunkoPop Frodo", "FunkoPopFrodo.png", SMPGenNHibernate.Enumerated.SMP.ValoracionEnum.dos, 100, "desclarga", "imagran", "Pequeña");
                int idproducto5 = productoCEN.New_ ("Figura Harley Quinn", 30, "Figura Harley Quinn", "HarleyQuinn.png", SMPGenNHibernate.Enumerated.SMP.ValoracionEnum.tres, 80, "desclarga", "imagran", "Pequeña");
