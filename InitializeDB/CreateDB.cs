...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                int idlineas_pedido = lineas_pedidoCEN.New_ (idCarrito, 3, idArticulo);
                ...
                int idpelicula = peliculaCEN.New_ (SMPGenNHibernate.Enumerated.SMP.ValoracionEnum.cinco, "nombre","imagen");
                int idvideo = videoCEN.New_ (SMPGenNHibernate.Enumerated.SMP.ValoracionEnum.cinco, "nombre","imagen");
                int idserie = serieCEN.New_ (SMPGenNHibernate.Enumerated.SMP.ValoracionEnum.cinco, "nombre","imagen");
